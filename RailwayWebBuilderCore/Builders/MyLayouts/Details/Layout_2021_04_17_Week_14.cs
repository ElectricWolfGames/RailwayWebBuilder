...
namespace RailwayWebBuilderCore.Builders.MyLayouts.Details
{
    public class Layout_2021_04_17_Week_14 : LayoutBase
    {
        public Layout_2021_04_17_Week_14()
        {
            ...
            Title = "<h2>New Rolling Stock and Chickens</h2>";
            Details.Append("<p>Welcome back to Cattington, We have been shopping and pickup some new rolling stock and other things.</p>");
