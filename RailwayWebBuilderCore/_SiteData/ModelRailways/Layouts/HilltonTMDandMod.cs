...
internal class HilltonTMDandMod : LayoutBase
{
    public HilltonTMDandMod()
    {
        Name = LayoutNamesEnums.HilltonTMDandMod;
        Owner = "P. Harris";
        Description = "The Hillton branch in South East Wales was a victim of the Beeching closures of the 1960’s. Due to the strategic importance of the Ministry of Defence facility on the outskirts of the town the track was not lifted and dismantled. </br></br>" +
