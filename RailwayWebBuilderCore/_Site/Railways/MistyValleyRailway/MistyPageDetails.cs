...
[AddGallery()]
public class MistyPageDetails : PageDetails
{
    public List<IMistyPagesDetails> LayoutDetails;
    private const int DetailsPerPage = 10;

    public MistyPageDetails()
    {
        WebPage = new WebPage(this);
        DisplayTitle = "MistyValleyRailway";
        MenuTitle = "MistyValleyRailway";
    ...
    private static string BuildDetails(IMistyPagesDetails detail)
    {
