    ...
    /* public static string NavBar(string offSet)
     {
         ...
         string heritageRailways = $"{offSet}{Constants.HeritageRailways}/HeritageRailways.html";
         ...
         stringBuilder.AppendLine($"<li class='nav-item active'><a class='nav-link' href='{heritageRailways}'>Heritage Railways</a></li>");
